...
const STATUS_ENUM_SQL = "ENUM('PENDENTE','ATRIBUIDO','EM_ANDAMENTO','PARADO','ATRASADO','CONCLUIDO','CANCELADO')"
const STATUS_ENUM_SQL_PREVIOUS = "ENUM('PENDENTE','ATRIBUIDO','EM_ANDAMENTO','PARADO','ATRASADO','CONCLUIDO')"

const STATUS_PENDENTES = "('PENDENTE', 'ATRIBUIDO')"
...
const createResumoEtapasView = async (knex, solicitacoesTable, etapasTable, stageTable) =>
  knex.schema.raw(
    ...
    SELECT
      ...
      SUM(CASE WHEN se.status IN ${STATUS_PENDENTES} THEN 1 ELSE 0 END) AS etapas_pendentes,
